...
#
# Script generated by Vivado on Wed Sep 16 00:10:15 IST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_cell.sh
...
#
# Usage        : bram_cell.sh
#                bram_cell.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_cell.sh [-rerun]
#                bram_cell.sh [-reset_run]
#                bram_cell.sh [-clean]
#                bram_cell.sh [-reset_log]
#                bram_cell.sh [-help]
#
...
#                script (type 'bram_cell.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_12 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_12 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bram_cell.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_cell.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bram_cell xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bram_cell -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/llamaglama/Documents/Github/whatever/rv32imfd/rv32imfd.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bram_cell_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_cell.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_cell.sh [-help]\n\
Usage: bram_cell.sh [-step]\n\
Usage: bram_cell.sh [-lib_map_path]\n\
Usage: bram_cell.sh [-rerun]\n\
Usage: bram_cell.sh [-reset_run]\n\
Usage: bram_cell.sh [-clean]\n\
Usage: bram_cell.sh [-reset_log]\n\
Usage: bram_cell.sh [-keep_index]\n\
Usage: bram_cell.sh [-noclean_files]\n\n\
