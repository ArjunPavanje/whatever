...
design_libs=(xpm blk_mem_gen_v8_4_12 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_cell xil_defaultlib.glbl -o bram_cell_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_cell_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/llamaglama/Documents/Github/whatever/rv32imfd/rv32imfd.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key bram_cell_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_cell_simv.daidir vcs_lib c.obj)
